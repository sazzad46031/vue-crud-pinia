                                ...
                                <div class="md:flex mb-8">
                                    <div class="form-control md:w-1/2">
                                        ...
                                        <input type="text" placeholder="Country Name" name="Country Name"
                                            v-model="country_name" class="input w-full input-bordered" />
                                    </div>
                                    <div class="form-control md:w-1/2 ml-4">
                                        ...
                                        <input type="text" placeholder="University Name" name="University Name"
                                            v-model="university_name" class="input w-full input-bordered" />
                                    </div>
                                </div>
                                <div class="md:flex mb-8">
                                    <div class="form-control md:w-1/2">
                                        ...
                                        <input type="text" placeholder="Course Name" name="Course Name"
                                            v-model="course_name" class="input w-full input-bordered" />
                                    </div>
                                    <div class="form-control md:w-1/2 ml-4">
                                        <label class="label">
        ...
        <div class="vue-card-body">
            <div class="overflow-x-auto">
                <table class="table">
                    ...
                    <tbody>
                        <!-- row 1 -->
                        <template v-for="(course, index) in courses" :key="course?.id || index">
                            <tr v-if="course && course.id">
                                <td>{{ course.id }}</td>
                                ...
                                <td class="space-x-4">
                                    ...
                                    <button @click="handleEditClick(course)" onclick="my_modal_3.showModal()"
                                        class="btn btn-success text-white">Edit</button>

                                    <button @click="courseStore.deleteCourse(course.id)"
